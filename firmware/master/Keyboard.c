...
void EVENT_USB_Device_ControlRequest(void)
{
	...
	switch (USB_ControlRequest.bRequest)
	{
		case HID_REQ_GetReport:
			...
			{
				MyUSB_KeyboardReport_Data_t KeyboardReportData;
...
{
	static MyUSB_KeyboardReport_Data_t PrevKeyboardReportData;
	MyUSB_KeyboardReport_Data_t        KeyboardReportData;
	...
	else
	{
		...
		SendReport = (memcmp(&PrevKeyboardReportData, &KeyboardReportData, sizeof(MyUSB_KeyboardReport_Data_t)) != 0);
	}
